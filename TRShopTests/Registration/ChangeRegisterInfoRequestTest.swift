//
//  ChangeRegisterInfoRequestTest.swift
//  TRShopTests
//
...
class ChangeRegisterInfoRequestTest: XCTestCase {
    ...
    func test_ChangeRegistation() throws {
        //Given
        ...
        let changeRegistration = RegistrationInfo(errorParser: ErrorParser(), sessionManager: session, queue: DispatchQueue.global(qos: .default), baseURL: baseURL)
        //When
        let register = expectation(description: "Change Registration info done")
    ...
    func test_WrongUrlChangeRegistration() throws {
        //Given
        let registrationData = RegistrationData(idUser: 123, username: "Someone", password: "mypassword", email: "some@some.ru", gender: "m", creditCard: "9872389-2424-234224-234", bio: "This is good! I think I will switch to another language")
        ...
        let changeRegistration = RegistrationInfo(errorParser: ErrorParser(), sessionManager: session, queue: DispatchQueue.global(qos: .default), baseURL: baseURL)
        //When
        let failedRegistration = expectation(description: "failed change registration info")
