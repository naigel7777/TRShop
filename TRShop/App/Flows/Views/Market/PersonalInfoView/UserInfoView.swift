...
class UserInfoView: UIView {
    ...
    let regButton: UIButton = {
        ...
        $0.setTitle("Change info", for: .normal)
    ...
    func registrationLayouts() {
       ...
       regButton.pin(to: backgroundView)
        ...
        regButton.addTarget(self, action: #selector(changeData), for: .touchUpInside)
        cancelButton.addTarget(self, action: #selector(exitFromUserInfo), for: .touchUpInside)
    }
